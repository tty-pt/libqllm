...
void mock_llama_set_n_head(int32_t n_head);
void mock_llama_set_n_head_kv(int32_t n_head_kv);
void mock_llama_set_vocab_size(int32_t size);
void mock_llama_set_chat_template(const char *tmpl);
...
int mock_llama_get_grammar_init_count(void);
...
void llama_memory_clear(llama_memory_t memory, bool editing);
